...
#
# These can be used to authenticate with a PKI-enabled EAS in a test environment, as with
# the `docker-compose.pki.yaml` test environment.
...
CA_CRT="$ROOT_CA_DIR/rootCA.pem"
CA_KEY="$ROOT_CA_DIR/rootCA-key.pem"
CA_SERIAL="$ROOT_CA_DIR/rootCA.srl"
