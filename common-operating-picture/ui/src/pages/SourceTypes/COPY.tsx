...
export function SourceTypeProvider({ children, srcType }: Props) {
  ...
  useEffect(() => {
    ...
    //Added Log To look at FormSchema
    console.log(JSON.stringify(createFormSchema, null, 2));
      ...
      properties: {
        ...
        ...(metadata?.searchFields || []).reduce((schema: any, field: string) => {
          ...
          try {
            ...
            console.error(`⚠️ Could not stringify field "${field}" — possible circular reference`, field);
          }
